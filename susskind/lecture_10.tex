...
If negative-energy particles exist, the vacuum (zero energy) is \textbf{unstable}: particle--antiparticle pairs can be created, lowering the total energy without bound.

\subsection{1.2 Dirac's solution (for fermions)}
\textbf{Fermions} obey the Pauli exclusion principle: no two particles can occupy the same state.  Dirac proposed that the vacuum is the state in which \emph{all} negative-energy levels are filled (the ``Dirac sea'').
\begin{itemize}[nosep]
    \item No further negative-energy particles can be added.
    \item A ``hole'' in the filled sea behaves as a positive-energy antiparticle.
    \item This picture applies to fermions (e.g.\ electrons, neutrinos) but \textbf{not} to bosons (e.g.\ photons), since bosons have no exclusion principle.
\end{itemize}
...
% ============================================================
\section{5. Course Summary and Outlook}
% ============================================================
